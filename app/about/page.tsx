        ...
        <article className="card">
          <div className="card-body detail-body">
            ...
            <section className="detail-section">
              ...
              <p className="detail-text">
                「視聴済み」機能を利用するには、Googleアカウントでのログインが必要です（ログインしなくても、配信情報の閲覧・検索・お気に入り等は今まで通りすべてご利用いただけます）。
              </p>
              <p className="detail-text">
                ログインすると、Googleから提供されるメールアドレス・氏名・アバター画像と、「視聴済み」にした作品ID・記録日時を、認証・データ保存の委託先であるSupabase（Supabase, Inc.、データ保存先は海外サーバーの場合があります）に保存します。これらの情報は現時点では視聴済み機能の提供のみに利用しており、属性分析やおすすめ機能等には使用していません（今後利用目的を追加する場合は、本ページで改めてご案内します）。
              </p>
              <p className="detail-text">
