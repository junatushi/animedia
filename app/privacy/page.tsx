          ...
          <div className="card-body detail-body">
            <section className="detail-section">
              ...
              <p className="detail-text">
                <strong>2026年9月9日より、当サイトは広告リンクの掲載を停止しています。</strong>
                現在、サイト上のどのページにも広告（アフィリエイト）リンクはありません。配信サービスの
                バッジのリンク先は、すべて各サービスの公式サイトです。
              </p>
              <p className="detail-text">
                掲載を再開する場合は、アフィリエイトサービスプロバイダ（ASP）が提供する
                アフィリエイトプログラムを利用し、配信サービスのバッジに広告リンクが含まれる場合は、
                そのバッジ列の直後に広告（アフィリエイト）を含む旨の説明文を表示します。リンク経由で
                配信サービスへの登録等が行われた場合、当サイトはASPから報酬を受け取ることがあります。
              </p>
              <p className="detail-text">
