...
const CHECKPOINTS = [
  ...
  {
    date: "2026-09-27",
    label: "通常枠へ戻った直後の答え合わせ",
    why:
      "3倍枠が切れた**後**を見る唯一の判定日（2026-09-05追加。㊶）。\n" +
      "**9/27なのは前の判定日（9/18）の窓（7日）の外に出す必要があるため**。\n" +
      "それまでの2回は「戻る前の見通し」しか確かめられず、**実際に通常枠へ戻れたか**は\n" +
      "誰も見ないままだった。対策のデプロイ由来の再生成の山も9/26〜27で30日の窓から\n" +
      "抜けるので、この時期の数字が平常時の実力に一番近い。\n" +
      "**特に Fluid Active CPU**（2026-09-02実測で上限の106%＝唯一の超過項目。\n" +
      "2026-09-03のキャッシュタグ修正で28%減る見込みだが実測がまだ無い）。",
  },
];
